...
130 S%(R)=N
131 POKE S+S%(R),H
132 LN=R-L+1:IFLN<0THENLN=LN+SZ+1
133 LN$=MID$(STR$(LN),2)
134 IFLEN(LN$)<3THENLN$=" "+LN$:GOTO134
135 POKES+22*22+19,ASC(MID$(LN$,1,1))+128
136 POKES+22*22+20,ASC(MID$(LN$,2,1))+128
137 POKES+22*22+21,ASC(MID$(LN$,3,1))+128
140 GETK$
