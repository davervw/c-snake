...
30 PRINT CHR$(17)"     "CHR$(18)"RETURN=PAUSE"
31 PRINT CHR$(17)"     "CHR$(18)"OR JOYSTICK"
...
134 J=0:TM=TI
135 DT=TI-TM
136 P=(NOTPEEK(37151)AND60)-2*(PEEK(37152)<128):IFP<>0THENJ=P
137 IFDT<SDTHENIFDT>=0THEN135
140 GETK$:IFK$<>""THEN150
141 IFJ=0THEN80
142 IFJ=4THENIFDX<>0ORDY<>1THENDX=0:DY=-1
143 IFJ=8THENIFDX<>0ORDY<>-1THENDX=0:DY=1
144 IFJ=2THENIFDX<>-1ORDY<>0THENDX=1:DY=0
145 IFJ=16THENIFDX<>1ORDY<>0THENDX=-1:DY=0
146 IFJ<>32THEN150
147 IFNOTPEEK(37151)AND32THEN147
148 IFPEEK(37151)AND32THEN148
149 IFNOTPEEK(37151)AND32THEN149
