...
134 J=0:TM=TI
135 DT=TI-TM
136 P=JOY(1):IFP<>0THENJ=P
137 IFDT<SDTHENIFDT>=0THEN135
140 IFJ<>0THEN142
141 GETK$:IFK$=""THEN80
142 IFJ=1THENIFDX<>0ORDY<>1THENDX=0:DY=-1
143 IFJ=5THENIFDX<>0ORDY<>-1THENDX=0:DY=1
144 IFJ=3THENIFDX<>-1ORDY<>0THENDX=1:DY=0
145 IFJ=7THENIFDX<>1ORDY<>0THENDX=-1:DY=0
146 IFJ<>128THEN150
147 IFJOY(1)=128THEN147
148 IFJOY(1)<>128THEN148
149 IFJOY(1)=128THEN149
...
210 GETK$:IFK$=""AND(JOY(1)AND128)=0THEN210
220 RUN
